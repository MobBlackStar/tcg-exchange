...
<section class="section" style="min-height: 100vh; display: flex; flex-direction: column; align-items: center; padding-top: 100px;">
    ...
    <div class="container" style="width: 100%; display: flex; flex-direction: column; align-items: center;">
        ...
        <form method="GET" action="{{ route('catalog') }}" style="display:flex; justify-content: center; gap:16px; margin: 0 auto 64px auto; width: 100%; max-width: 1000px; background:hsl(var(--card)/.8); padding: 24px; border: 4px solid var(--ink-c); box-shadow: 6px 6px 0 var(--ink-c), 12px 12px 0 var(--a3);">
                ...
                <div class="tcard {{ $glow }}" style="width: 100%; max-width: 320px;">
                    ...
                    <div class="body" style="display: flex; flex-direction: column; align-items: center; text-align: center; padding: 24px;">
                        ...
                        <div style="width: 100%; display: flex; flex-direction: column; gap: 10px;">
                            ...
                            <!-- Using Sarah's addToCart JS function via notification proxy -->
                            <button onclick="addToCart({{ $card->id }})" class="btn yellow sm full" style="padding: 8px; font-family: 'Share Tech Mono'; cursor:pointer;">
